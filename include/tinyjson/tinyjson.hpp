...
protected:
            ...
            while (szStart < szEnd)
            {
                ...
                else
                {
                    ...
                    case 'u':
                    {
                        ...
                        (std::basic_string < typename Iterator::value_type >
                        (&szStart[1],
                                4)) >> std::hex >> iUnicode;
    ...
    struct push_boolean
    {
        ...
        void operator() (Iterator szStart, Iterator /* szEnd */ ) const
        {
            ...
            m_stack.push(variant(new boost::
    ...
    struct end_object
    {
        ...
        void operator() (Iterator /* cCharacter */ ) const
        {
            ...
            while (!m_stack.empty())
            {
                ...
                (varObject.get())->
                insert(std::make_pair(pPair->first, pPair->second));
            }
